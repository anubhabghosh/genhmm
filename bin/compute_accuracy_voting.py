...
if __name__ == "__main__":
    ...
    file1 = open("./log/metrics_class_all_test_3.log", "w+") # Opening the file
    df_filename = "./log/metrics_class_all_test_3.json" # Define an excel file name for storing log results using dataframes
    correct_gmm = 0
    correct_nvp = 0
    correct_glow = 0
    correct_voted = 0
