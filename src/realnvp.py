...
>>>>>>> 3acb3dbfc6ed59dc55a19f1bb29ca0f8db5f3eaa
    ...
    def __init__(self, nets, mask, prior):
        ...
        self.prior = prior # This initialises the prior distribution (P_z) in the latent space
        self.mask = torch.nn.Parameter(mask, requires_grad=False) # In the actual NVP paper, masks are used for implementing the mappings
