...
if __name__ == "__main__":
    ...
    # Since the phone labels for the dev set will also be required to be obtained from the TIMIT Test labels (full set)
    # as dev set is a subset of the full test set
    DATA_TYPE = "TEST" if (("test" in outfile) or ("dev" in outfile)) else "TRAIN"
